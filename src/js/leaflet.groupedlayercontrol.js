(L.Control.GroupedLayers = L.Control.extend({
  ...
  _addItem: function(a) {
    ...
    a.overlay
      ? a.group.exclusive
        ? ((groupRadioName = "leaflet-exclusive-group-layer-" + a.group.id),
          (b = this._createRadioElement(groupRadioName, e)))
    ...
    if (
      ...
      if (!g) {
        ...
        if (
          ((h.className = "leaflet-control-layers-group-label"),
          "" != a.group.name &&
            !a.group.exclusive &&
          ...
          (i.type = "checkbox"),
            ...
            (i.legend = this),
            L.DomEvent.on(i, "click", this._onGroupInputClick, i),
            h.appendChild(i);
        }
    ...
    for (a = 0; e > a; a++)
      (b = d[a]),
        b.groupID == this.groupID &&
          ...
          b.checked && !this_legend._map.hasLayer(c.layer)
            ? this_legend._map.addLayer(c.layer)
            : !b.checked &&
              this_legend._map.hasLayer(c.layer) &&
              this_legend._map.removeLayer(c.layer));
